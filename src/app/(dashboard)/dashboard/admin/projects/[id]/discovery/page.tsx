...
export default async function AdminDiscoveryPage({ params }: { params: Promise<{ id: string }> }) {
  await requireAdmin();
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#F4F5F9] p-6 lg:p-10 space-y-6">
      ...
      <StageCard
        ...
        status={status}
        title="Discovery"
        description="Review and approve the client's discovery questionnaire responses."
        isAdmin={true}
        projectId={id}
