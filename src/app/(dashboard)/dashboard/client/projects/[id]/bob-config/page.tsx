  ...
  return (
    <div className="min-h-full bg-[#F4F5F9] px-7 py-6 space-y-6">
      ...
      <StageCard
        ...
        description="Complete the HiBob configuration checklist to prepare your HR data for integration."
        isAdmin={false}
        projectId={id}
      ...
      >
        <div className="rounded-xl bg-violet-50 border border-violet-100 p-6 text-center">
          ...
          <p className="text-xs text-violet-500 mt-1">Configuration checklist with embedded FAQ and Loom videos.</p>
        </div>
        {status !== "locked" && (
