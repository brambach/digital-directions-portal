                ...
                <div className="p-6 pb-2">
                    ...
                    <div className="relative mb-2">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-lg text-sm outline-none focus:ring-2 focus:ring-indigo-100 focus:border-indigo-200 transition-all placeholder:text-gray-400"
                        />
                    </div>
                </div>
                            ...
                            <div className="flex gap-3 pl-2">
                                <div className="relative flex-shrink-0">
                                    <div className={cn(
                                        ...
                                        selectedProjectId === project.id ? "bg-indigo-600" : "bg-gray-900"
                                    )}>
                                ...
                                <div className="flex-1 min-w-0 flex flex-col justify-center">
                                    ...
                                    <div className="flex items-center gap-1.5">
                                        <span className="text-xs text-indigo-600 font-medium truncate">@{project.clientName.replace(/\s+/g, '').toLowerCase()}</span>
                                    </div>
                    ...
                    <>
                                            ...
                                            return (
                                                <div key={msg.id || idx} className={cn("flex gap-4 max-w-[75%]", isMe ? "ml-auto flex-row-reverse" : "")}>
                                                    ...
                                                    <div className="flex-shrink-0 self-end">
                                                        {isMe ? (
                                                            <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 text-[10px] font-bold">ME</div>
                                                        ) : (
                                                            msg.senderAvatar ? (
                        ...
                        <div className="p-6 bg-white border-t border-gray-100">
                            <form onSubmit={handleSendMessage} className="relative">
                                <div className="border border-gray-200 rounded-xl shadow-sm focus-within:ring-2 focus-within:ring-indigo-100 focus-within:border-indigo-300 transition-all bg-white overflow-hidden">
                                    <textarea
                                        value={messageInput}
                                    ...
                                    <div className="flex items-center justify-between px-3 pb-3 pt-1">
                                        ...
                                        <Button
                                            ...
                                            className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg px-4 h-9 shadow-sm transition-all disabled:opacity-50"
                                        >
