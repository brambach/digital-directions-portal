                ...
                <div className="p-4 border-b border-gray-100">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 bg-gray-50 border-none rounded-xl text-sm outline-none focus:ring-2 focus:ring-purple-100 transition-all"
                        />
                    </div>
                </div>
                    ...
                    {filteredProjects.map((project) => (
                        <div
                            ...
                            className={cn(
                                ...
                                selectedProjectId === project.id ? "bg-purple-50/40" : ""
                            )}
                        >
                            <div className="relative">
                                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-600 to-purple-700 flex items-center justify-center text-white font-bold text-sm shadow-sm shadow-purple-100">
                    ...
                    <>
                        ...
                        <div className="h-16 border-b border-gray-200 bg-white flex items-center justify-between px-6 flex-shrink-0">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-xl bg-purple-100 flex items-center justify-center text-purple-700 font-bold shadow-sm">
                                ...
                                messages.map((msg, idx) => {
                                    ...
                                    return (
                                        <div key={msg.id || idx} className={cn("flex gap-4 max-w-[80%]", isMe ? "ml-auto flex-row-reverse" : "")}>
                                            ...
                                            {isMe && (
                                                <div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center text-purple-700 text-[10px] font-bold self-end shrink-0">ME</div>
                                            )}
                                            ...
                                            <div>
                                                <div className={cn(
                                                    ...
                                                    isMe
                                                        ? "bg-purple-700 text-white rounded-br-sm shadow-purple-200"
                        ...
                        <div className="p-4 bg-white border-t border-gray-200">
                            <form onSubmit={handleSendMessage}>
                                <div className="bg-gray-50 border border-gray-200 rounded-2xl p-2 flex items-center gap-2 focus-within:ring-2 focus-within:ring-purple-100 focus-within:border-purple-200 transition-all">
                                    ...
                                    <button
                                        ...
                                        className="p-2 bg-purple-700 text-white rounded-xl shadow-sm hover:bg-purple-800 transition-colors active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
