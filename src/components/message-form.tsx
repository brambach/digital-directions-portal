  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      <textarea
        ...
        className="w-full bg-white border border-gray-200 rounded-lg p-3 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-purple-100 focus:border-purple-400 text-gray-900 placeholder:text-gray-400"
        rows={3}
        value={content}
